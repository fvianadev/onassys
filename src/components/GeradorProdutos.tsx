    ...
    const printContent = `
      ...
      <body>
        ...
        <table>
          ...
          `).join('')}
          <tr class="total"><td>valor de Custo Uni.</td><td></td><td class="right">R$ ${totalCustoProd.toFixed(2).replace('.', ',')}</td></tr>
        </table>
      </body>
      </html>
    `;
          ...
          <div className="bg-white dark:bg-[#120c06] rounded-xl border border-amber-100 dark:border-[#2d1e0d] p-4 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-10 gap-2 items-center pt-2 border-t border-amber-100 dark:border-[#2d1e0d]">
                <div className="col-span-4 text-[10px] font-bold text-amber-900 dark:text-amber-200">valor de Custo Uni.</div>
